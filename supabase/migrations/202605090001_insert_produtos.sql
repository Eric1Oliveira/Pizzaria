-- =============================================================
-- INSERÇÃO DE PRODUTOS — Casa José Silva Pizzaria
-- Execute no SQL Editor do Supabase
-- codigo_saipos: preencher após configurar integração Saipos
-- =============================================================
...
-- =============================================
-- VINHOS E ESPUMANTES
-- disponivel=false nos vinhos sem preço definido
-- Atualize o preço e mude disponivel=true antes de publicar
-- =============================================
INSERT INTO public.produtos (nome, descricao, preco, categoria, subcategoria, disponivel, destaque, ordem, midias, midias_types, codigo_saipos) VALUES
-- Com preço confirmado
('Cachaça da Fazenda Bai Perini 600ml',                      NULL, 165.00, 'Vinhos e Espumantes', 'Destilados',    true,  false,  1, ARRAY[]::text[], ARRAY[]::text[], NULL),
('Cachaça Brut Casa Perini 750ml',                           NULL,  89.90, 'Vinhos e Espumantes', 'Destilados',    true,  false,  2, ARRAY[]::text[], ARRAY[]::text[], NULL),
('Espumante Brut Casa Perini 750ml',                         NULL,  89.90, 'Vinhos e Espumantes', 'Espumantes',    true,  false,  3, ARRAY[]::text[], ARRAY[]::text[], NULL),
('Espumante Cava Península 750ml',                           NULL,  89.90, 'Vinhos e Espumantes', 'Espumantes',    true,  false,  4, ARRAY[]::text[], ARRAY[]::text[], NULL),
('Espumante Demi-Sec Casa Perini 750ml',                     NULL,  89.90, 'Vinhos e Espumantes', 'Espumantes',    true,  false,  5, ARRAY[]::text[], ARRAY[]::text[], NULL),
('Vodka Absolut Original 750ml',                             NULL,  85.00, 'Vinhos e Espumantes', 'Destilados',    true,  false,  6, ARRAY[]::text[], ARRAY[]::text[], NULL),
('Vodka Absolut Citron 750ml',                               NULL,  85.00, 'Vinhos e Espumantes', 'Destilados',    true,  false,  7, ARRAY[]::text[], ARRAY[]::text[], NULL),
-- Sem preço definido — disponivel=false até você atualizar o preço no admin
('Vinho Argentino Tinto Portillo Malbec 750ml',              NULL,   0.00, 'Vinhos e Espumantes', 'Vinhos Tintos', false, false,  8, ARRAY[]::text[], ARRAY[]::text[], NULL),
...
('Vinho Chileno Tinto Carmenere Santa Carolina 750ml',       NULL,   0.00, 'Vinhos e Espumantes', 'Vinhos Tintos', false, false, 10, ARRAY[]::text[], ARRAY[]::text[], NULL),
('Vinho Italiano Tinto Negroamaro 750ml',                    NULL,   0.00, 'Vinhos e Espumantes', 'Vinhos Tintos', false, false, 11, ARRAY[]::text[], ARRAY[]::text[], NULL),
('Vinho Tinto Casa Perini Cabernet Sauvignon 750ml',         NULL,   0.00, 'Vinhos e Espumantes', 'Vinhos Tintos', false, false, 12, ARRAY[]::text[], ARRAY[]::text[], NULL),
('Vinho Tinto Chileno Carmenere 750ml',                      NULL,   0.00, 'Vinhos e Espumantes', 'Vinhos Tintos', false, false, 13, ARRAY[]::text[], ARRAY[]::text[], NULL);

-- =============================================
-- BEBIDAS
-- =============================================
INSERT INTO public.produtos (nome, descricao, preco, categoria, subcategoria, disponivel, destaque, ordem, midias, midias_types, codigo_saipos) VALUES
('Água Mineral 500ml',             NULL,  5.00, 'Bebidas', NULL,           true, false,  1, ARRAY[]::text[], ARRAY[]::text[], NULL),
('Água Mineral com Gás 500ml',     NULL,  7.00, 'Bebidas', NULL,           true, false,  2, ARRAY[]::text[], ARRAY[]::text[], NULL),
('Cerveja Heineken 600ml',         NULL, 24.90, 'Bebidas', 'Cervejas',     true, false,  3, ARRAY[]::text[], ARRAY[]::text[], NULL),
('Cerveja Heineken Long Neck 330ml',NULL,14.90, 'Bebidas', 'Cervejas',     true, false,  4, ARRAY[]::text[], ARRAY[]::text[], NULL),
('Cerveja Original 600ml',         NULL, 24.90, 'Bebidas', 'Cervejas',     true, false,  5, ARRAY[]::text[], ARRAY[]::text[], NULL),
('Coca Cola 2 litros',             NULL, 18.00, 'Bebidas', 'Refrigerantes',true, false,  6, ARRAY[]::text[], ARRAY[]::text[], NULL),
('Coca Cola Zero 2 litros',        NULL, 18.00, 'Bebidas', 'Refrigerantes',true, false,  7, ARRAY[]::text[], ARRAY[]::text[], NULL),
('Energético Monster 473ml',       NULL, 15.00, 'Bebidas', 'Energéticos',  true, false,  8, ARRAY[]::text[], ARRAY[]::text[], NULL),
('Energético Red Bull 250ml',      NULL, 18.00, 'Bebidas', 'Energéticos',  true, false,  9, ARRAY[]::text[], ARRAY[]::text[], NULL),
('Guaraná Antarctica 2 litros',    NULL, 16.00, 'Bebidas', 'Refrigerantes',true, false, 10, ARRAY[]::text[], ARRAY[]::text[], NULL),
('Guaraná Antarctica Zero 2 litros',NULL,16.00, 'Bebidas', 'Refrigerantes',true, false, 11, ARRAY[]::text[], ARRAY[]::text[], NULL),
('H2O Limão 500ml',                NULL,  8.00, 'Bebidas', NULL,           true, false, 12, ARRAY[]::text[], ARRAY[]::text[], NULL),
('Pepsi 350ml',                    NULL, 13.00, 'Bebidas', 'Refrigerantes',true, false, 13, ARRAY[]::text[], ARRAY[]::text[], NULL),
('Pepsi Zero 350ml',               NULL, 13.00, 'Bebidas', 'Refrigerantes',true, false, 14, ARRAY[]::text[], ARRAY[]::text[], NULL),
('Schweppes Citrus 350ml',         NULL, 13.00, 'Bebidas', 'Refrigerantes',true, false, 15, ARRAY[]::text[], ARRAY[]::text[], NULL),
('Suco de Uva ou Laranja',         NULL, 13.00, 'Bebidas', NULL,           true, false, 16, ARRAY[]::text[], ARRAY[]::text[], NULL),
('Soda Limonada 350ml',            NULL, 13.00, 'Bebidas', 'Refrigerantes',true, false, 17, ARRAY[]::text[], ARRAY[]::text[], NULL);

COMMIT;

-- =============================================================
-- APÓS INTEGRAR COM SAIPOS:
-- Execute UPDATEs para vincular o codigo_saipos de cada produto.
-- Exemplo:
--   UPDATE public.produtos SET codigo_saipos = 'COD-SAIPOS-123'
